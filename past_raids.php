...
?>
    <div id="body">
        ...
        <div class="right_col">
            <div class="header_title">DKP: Past Raids</div>
            <div class="body_style">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td width="37%" class="text_header">Description</td>
                        <td width="8%" class="text_header">Points</td>
                        <td width="10%" class="text_header">Members</td>
                    </tr>
                    <?php
                    for ($i = 0; $i < $raid["count"]; $i++) {
                        ...
                        ?>
                        <tr>
                            <td class="text_normal"><a href="view_raid.php?raid_id=<?php echo $raid[$i]["raid_id"]; ?>"><?php echo date("m/d/Y", $raid[$i]["event_date"]) . " - " . $raid[$i]["event_name"]; ?></a></td>
