...
?>
    <div id="body">
        ...
        <div class="right_col">
            <div class="header_title">DKP: Current Standings</div>
            <div class="body_style">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td width="10%" class="text_header">Raids</td>
                    ...
                    for ($i = 0; $i < $current["count"]; $i++) {
                        read_char_raids($current[$i]["roster_id"], $char_raid_count, $raid_count)
                        ?>
                        <tr>
                            <td class="text_normal"><?php echo $current[$i]["roster_charfirst"]; ?></td>
                            <td class="text_normal"><?php echo $CLASS[$current[$i]["roster_class"]]; ?></td>
                            <td class="text_normal"><?php echo (($char_raid_count["max"] > 0) ? round(($char_raid_count["max"] / $raid_count["max"]) * 100) : 0); ?>%</td>
